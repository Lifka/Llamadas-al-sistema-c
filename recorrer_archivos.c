...
/* El siguiente programa recorre los archivos de un directorio y modifica los permisos de todos los
archivos. Recibe como parámetros un directorio y un número.*/
...
int main(int argc, char *argv[]) {
	...
	if (argc != 3){
		perror("Syntax error: ./act2 <pathname> <4_digits>");
		exit(EXIT_FAILURE);
	}
